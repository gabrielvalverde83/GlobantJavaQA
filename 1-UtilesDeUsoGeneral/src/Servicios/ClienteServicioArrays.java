...
import Entidades.ClienteConIdArrays;
...
public class ClienteServicioArrays {

    ArrayList<ClienteConIdArrays> clientes = new ArrayList<>();
    Scanner leer = new Scanner(System.in).useDelimiter("\n");

    public void inicializarClientes() {
        //3 maneras distintas de crear objetos y agregarlos al arraylist
        
        ClienteConIdArrays cli1 = new ClienteConIdArrays("Pepita", 45, 180, 78, "Bajar Peso");
        clientes.add(cli1);

        clientes.add(new ClienteConIdArrays("Juanelo", 40, 200, 55, "Marcar"));
        clientes.add(new ClienteConIdArrays("Juanelo", 25, 175, 80, "Marcar"));
        clientes.add(new ClienteConIdArrays("Juanelo", 45, 145, 60, "Marcar"));
        
        //otra forma de agregar
        
        ClienteConIdArrays cli2 = new ClienteConIdArrays();
    ...
    public void registrarCliente() {
        ClienteConIdArrays clienteAux = new ClienteConIdArrays();
        boolean validacion;
    ...
    public void actualizarCliente() {
            ...
            ClienteConIdArrays opcion = encontrarClientes();
    ...
    public ClienteConIdArrays encontrarClientes() {
        
        System.out.println("");
        System.out.println("Ingrese el nombre para la búsqueda");
        ArrayList<ClienteConIdArrays> resultset = new ArrayList();
        ...
        String respuesta;
        ClienteConIdArrays clienteOpcion = new ClienteConIdArrays();
        ...
        if (resultset.size() > 1) {
            ...
            Optional<ClienteConIdArrays> clienteEncontrado = clientes.stream()
